...
st.subheader("3d Scatterplot of Education, Median Wage, and Employment Growth")


fig2 = px.scatter_3d(
    dfb,
    x="Typical_Entry_Level_Education",
    y="Median Annual Wage 2021",
    z="Employment_Percent_Change_2021_2031",
    symbol="Typical_Entry_Level_Education",
    opacity=0.7,
...
fig2.update_layout(
    ...
    scene=dict(xaxis_title=" ", yaxis_title="Wage", zaxis_title="% Change 2021-2031"),
)
